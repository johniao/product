...
flags.DEFINE_string('input_shape', None,
                    ...
                    '`[None, None, None, 3]`.')
flags.DEFINE_string('pipeline_config_path', '/home/jy/ttt/5model/ssd_mobilenet_v1_pets.config',
                    'Path to a pipeline_pb2.TrainEvalPipelineConfig config '
                    'file.')
flags.DEFINE_string('trained_checkpoint_prefix', '/home/jy/ttt/5model/output/model.ckpt-50000',
